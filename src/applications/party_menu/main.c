...
static const u16 sFieldMoves[FIELD_MOVE_MAX] = {
    [FIELD_MOVE_CUT] = MOVE_NONE,
    [FIELD_MOVE_FLY] = MOVE_NONE,
    [FIELD_MOVE_SURF] = MOVE_NONE,
    [FIELD_MOVE_STRENGTH] = MOVE_NONE,
    [FIELD_MOVE_DEFOG] = MOVE_NONE,
    [FIELD_MOVE_ROCK_SMASH] = MOVE_NONE,
    [FIELD_MOVE_WATERFALL] = MOVE_NONE,
    [FIELD_MOVE_ROCK_CLIMB] = MOVE_NONE,
