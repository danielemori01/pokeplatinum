...
_0006:
    ...
    SetFlag FLAG_HIDE_SURVIVAL_AREA_BUCK
    SetFlag FLAG_HIDE_SURVIVAL_AREA_RIVAL
    SetFlag FLAG_HIDE_STARK_MOUNTAIN_ROOM_3_LOOKER
    SetFlag FLAG_HIDE_STARK_MOUNTAIN_ROOM_3_POLICEMEN
    SetFlag FLAG_HIDE_STARK_MOUNTAIN_ROOM_3_CROAGUNK
    SetFlag FLAG_HIDE_STARK_MOUNTAIN_ROOM_3_HEATRAN
    SetFlag FLAG_HIDE_STARK_MOUNTAIN_ROOM_2_BUCK
    SetFlag FLAG_HIDE_STARK_MOUNTAIN_OUTSIDE_LOOKER
    SetFlag FLAG_HIDE_STARK_MOUNTAIN_OUTSIDE_BUCK
    SetFlag FLAG_HIDE_DAY_CARE_GYM_GUIDE
    SetFlag FLAG_HIDE_SOLACEON_TOWN_RIVAL
    SetFlag FLAG_HIDE_SNOWPOINT_CITY_CANDICE
    SetFlag FLAG_HIDE_SNOWPOINT_CITY_CYNTHIA
    ...
    SetFlag FLAG_HIDE_TURNBACK_CAVE_GIRATINA_ROOM_ITEM
    ...
    SetFlag FLAG_HIDE_SPEAR_PILLAR_DISTORTED_CYNTHIA
    SetFlag FLAG_HIDE_SPEAR_PILLAR_DISTORTED_MESPRIT
    SetFlag FLAG_HIDE_ROUTE_205_SOUTH_YOUNGSTER
    SetFlag FLAG_HIDE_ROUTE_217_MAYLENE
    SetFlag FLAG_HIDE_SUNYSHORE_CITY_RIVAL
